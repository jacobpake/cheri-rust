...
pub unsafe fn store_f32x2(mask: Vec2<i32>, pointer: *mut f32, values: Vec2<f32>) {
    ...
    //                                                                               ^^^^^
    // LLVM22: call[[ADDRSPACE]] void @llvm.masked.store.v2f32.{{p0|p200}}(<2 x float> {{.*}}, ptr[[ADDRSPACE]] align 4 {{.*}}, <2 x i1> [[B]])
    //                                                                       ^^^^^^^
...
pub unsafe fn store_f32x2_aligned(mask: Vec2<i32>, pointer: *mut f32, values: Vec2<f32>) {
    ...
    //                                                                               ^^^^^
    // LLVM22: call[[ADDRSPACE]] void @llvm.masked.store.v2f32.{{p0|p200}}(<2 x float> {{.*}}, ptr[[ADDRSPACE]] align 8 {{.*}}, <2 x i1> [[B]])
    //                                                                       ^^^^^^^
...
pub unsafe fn store_f32x2_unaligned(mask: Vec2<i32>, pointer: *mut f32, values: Vec2<f32>) {
    ...
    //                                                                               ^^^^^
    // LLVM22: call[[ADDRSPACE]] void @llvm.masked.store.v2f32.{{p0|p200}}(<2 x float> {{.*}}, ptr[[ADDRSPACE]] align 1 {{.*}}, <2 x i1> [[B]])
    //                                                                       ^^^^^^^
...
pub unsafe fn store_pf32x4(mask: Vec4<i32>, pointer: *mut *const f32, values: Vec4<*const f32>) {
    ...
    // LLVM22: call[[ADDRSPACE]] void @llvm.masked.store.v4{{p0|p200}}.{{p0|p200}}(<4 x ptr[[ADDRSPACE]]> {{.*}}, ptr[[ADDRSPACE]] align {{.*}} {{.*}}, <4 x i1> [[B]])
    simd_masked_store::<_, _, _, { SimdAlign::Element }>(mask, pointer, values)
}
